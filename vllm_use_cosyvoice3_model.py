...
class CosyVoice3Model(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.sos_eos_token_id = self.llm_token_id_delta + torch.tensor(self.llm_token_size, dtype=torch.int32)
        self.task_token_id = self.sos_eos_token_id + torch.tensor(1, dtype=torch.int32)
